...
/**
 * Carattere che l'utente può inserire in un prompt per confermare una richiesta del programma.
 */
#define PROMPT_CONFERMA 'y'
/**
 * Carattere che l'utente può inserire in un prompt per rifiutare una richiesta del programma.
 */
...
#define ROLES_NUMBER 4
 ...
 /**
  * Intero contenente i punti vita di uno sceriffo
  */
#define PUNTI_VITA_SCERIFFO 5
 /**
  * Intero contenente i punti vita di un giocatore generico
  */
